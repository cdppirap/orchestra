...
def get_rest_module_info_url(module_id):
    return os.path.join(get_rest_base_url(),"module/{}".format(module_id))
...
def get_rest_module_run_url(module_id, **kwargs):
    ...
    return os.path.join(get_rest_base_url(),"module/{}/run?{}".format(module_id, s))
def get_rest_tasks_url():
    return os.path.join(get_rest_base_url(),"tasks")
def get_rest_task_info_url(task_id):
    return os.path.join(get_rest_base_url(),"task/{}".format(task_id))
def get_rest_task_output_url(task_id):
    return os.path.join(get_rest_base_url(),"task/{}/output".format(task_id))
